    ...
    // windows nvidia
    {
      ...
      "params": {
        ...
        "message": [
          ...
          "uv pip install https://github.com/mjun0812/flash-attention-prebuild-wheels/releases/download/v0.9.26/flash_attn-2.8.3+cu130torch2.12-cp310-cp310-win_amd64.whl --force-reinstall",
        ]
      }
    },
    // windows amd
